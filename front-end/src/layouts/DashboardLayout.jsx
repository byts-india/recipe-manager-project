    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <header className="bg-white shadow-md">
                <div className="w-[100vw] flex justify-between items-center max-w-7xl mx-auto px-4 py-6">
                    <div className="text-black font-semibold">
                        {`${userDetails?.name?.firstName || ""} ${userDetails?.name?.lastName || ""}`}
                    </div>
                    <div className="flex justify-around space-x-10">
                        <div style={location.pathname === "/dashboard" ? activeStyle : inActiveStyle} >
                            <Link to="/dashboard">
                                home
                            </Link>
                        </div>
                        <div style={location.pathname === "/dashboard/settings" ? activeStyle : inActiveStyle} >
